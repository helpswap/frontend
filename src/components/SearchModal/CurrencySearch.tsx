import { Currency, ETHER, Token } from '@/helpswap/sdk'
...
export function CurrencySearch({
  ...
  //console.log("allTokens:", filteredSortedTokens, filteredTokens, allTokens)
      ...
      <PaddedColumn gap="14px">
        <RowBetween>
          <Text>
            {t('select-token')}
            <QuestionHelper
              text={t('find-token-help')}
            />
          </Text>
          <Box as={FaTimes} cursor="pointer" onClick={onDismiss} />
        </RowBetween>
        <SearchInput
          type="text"
        ...
        <>
          ...
          <Card>
            <RowBetween>
              ...
              >
                {selectedListInfo.current ? t('change') : t('select-list')}
              </LinkStyledButton>
            </RowBetween>
          </Card>
        </>
