...
import { CheckmarkCircleIcon, ErrorIcon, Flex, LinkExternal, Modal, Button } from '@pancakeswap-libs/uikit'
...
const RecentTransactionsModal = ({ onDismiss = defaultOnDismiss, translateString }: RecentTransactionsModalProps) => {
  ...
  return (
    <Modal title={translateString('Recent transactions')} onDismiss={onDismiss}>
      {!account && (
